                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      const SizedBox(height: 24),
                      _buildLinearStat('Fokus Anak', controller.fokusAnak.value, const Color(0xFF2977C7)),
                      const SizedBox(height: 16),
                      _buildLinearStat('Kecepatan Membaca', controller.kecepatanMembaca.value, const Color(0xFFE26C22)),
                      const SizedBox(height: 16),
                      _buildLinearStat('Pengenalan Huruf', controller.pengenalanHuruf.value, const Color(0xFF4CAF50)),
                    ],
                  ),
                ),
                const SizedBox(height: 24),
