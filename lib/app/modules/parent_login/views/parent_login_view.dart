...
class ParentLoginView extends GetView<ParentLoginController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xFFFAF9EF), // Match child login
      body: SafeArea(
        child: Center(
    ...
    Get.dialog(
      AlertDialog(
        ...
        content: Column(
          ...
          children: [
            Text(
              'Masukkan email Anda yang terdaftar. Kami akan mengirimkan tautan reset kata sandi.',
          ...
          ElevatedButton(
            onPressed: () {
              ...
              if (email.isNotEmpty) {
                ...
                }).whenComplete(() => controller.isLoading.value = false);
              }
            },
            style: ElevatedButton.styleFrom(
              backgroundColor: const Color(0xFF1A3A6B),
